...
$url = "https://www.wireshark.org/download/win32/all-versions/Wireshark-win32-2.2.2.exe"
$url64 = "https://www.wireshark.org/download/win64/all-versions/Wireshark-win64-2.2.2.exe"
