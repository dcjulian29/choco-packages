...
$url = "https://github.com/syncthing/syncthing/releases/download/v0.10.23/syncthing-windows-amd64-v0.10.23.zip"
...
try {
    ...
    New-ItemProperty -Path $location -Name $packageName -Value "$appdir\syncthing.exe -noconsole -no-browser"
