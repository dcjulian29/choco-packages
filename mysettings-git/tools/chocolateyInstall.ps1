...
& $git config --global --replace-all alias.f "fetch -p"
...
& $git config --global --replace-all alias.removemerged "!git branch --merged | grep -v '*' | xargs -n 1 git branch -d"
...
& $git config --global --replace-all alias.ls "log --oneline"
