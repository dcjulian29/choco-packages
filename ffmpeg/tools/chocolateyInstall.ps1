$packageName = "ffmpeg"
$url = "http://ffmpeg.zeranoe.com/builds/win32/static/ffmpeg-20160308-git-5061579-win32-static.7z"
$url64 = "http://ffmpeg.zeranoe.com/builds/win64/static/ffmpeg-20160308-git-5061579-win64-static.7z"
