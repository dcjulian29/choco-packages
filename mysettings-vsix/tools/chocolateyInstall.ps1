...
Install-ChocolateyVsixPackage "Web Essentials" `
    "$vsgallery/ee6e6d8c-c837-41fb-886a-6b50ae2d06a2/file/146119/48/Web%20Essentials%202015.3%20v3.0.235.vsix"

Install-ChocolateyVsixPackage "I Hate #Regions" `
    "$vsgallery/0ca60d35-1e02-43b7-bf59-ac7deb9afbca/file/69113/8/DisableRegions.vsix"

Install-ChocolateyVsixPackage "Productivity Power Tools" `
    "$vsgallery/34ebc6a2-2777-421d-8914-e29c1dfa7f5d/file/169971/1/ProPowerTools.vsix"

Install-ChocolateyVsixPackage "Git Diff Margin" `
...
Install-ChocolateyVsixPackage "SQLite / SQL Server Compact Toolbox" `
    "$vsgallery/0e313dfd-be80-4afb-b5e9-6e74d369f7a1/file/29445/85/SqlCeToolbox.4.5.0.3.vsix"

Install-ChocolateyVsixPackage "Visual StyleCop" `
    "$vsgallery/cac2a05b-6eb6-4fa2-95b9-1f8d011e6cae/file/173746/14/VSIXPackage.vsix"

Install-ChocolateyVsixPackage "SlowCheetah - XML Transforms" `
